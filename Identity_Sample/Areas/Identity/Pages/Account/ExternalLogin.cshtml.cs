...
namespace Identity_Sample.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost(string provider, string returnUrl = null)
        {
            ...
            {
                return NotFound("Invalid provider: " + provider);
            }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((userWithExternalEmail != null) && (Input.Email == externalEmail))
                {
                    ...
                    {
                        await _signInManager.SignInAsync(userWithExternalEmail, false);
                        return ViewComponent(MessagePage.COMPONENTNAME, new MessagePage.Message
                        {
                            title = "Linking Account",
                            htmlcontent = $"Linking account {userWithExternalEmail.UserName} with {info.ProviderDisplayName} successfully.",
                    ...
                    else
                    {
                        ...
                        {
                            title = "Linking Account",
                            htmlcontent = $"Linking account {userWithExternalEmail.UserName} failed.",
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        if (user.Email == externalEmail)
                        {
                            ...
                            return ViewComponent(MessagePage.COMPONENTNAME, new MessagePage.Message
                            {
                                title = "Create and Linking Account",
                                htmlcontent = $"Account {user.Email} has been created and activated successfully.",
                                urlredirect = returnUrl
                            });
                        }
